...
import { FaUser, FaFolderOpen, FaLink } from "react-icons/fa";
      ...
      >
        ...
        <div onClick={handleDrawerClose}>
          <div className="navLink--container">
            <Fade left>
              <NavLink to={{ pathname: headerData.linktree }} target="_blank">
                <div className={classes.drawerItem}>
                  <FaLink className={classes.drawerIcon} />
                  <span className={classes.drawerLinks}>Connect</span>
                </div>
              </NavLink>
            </Fade>
            ...
            <Fade left>
              <NavLink to="/#test" smooth={true} spy="true" duration={2000}>
                <div className={classes.drawerItem}>
                  <MdPublic className={classes.drawerIcon} />
                  <span className={classes.drawerLinks}>Posts</span>
                </div>
              </NavLink>
            </Fade>
